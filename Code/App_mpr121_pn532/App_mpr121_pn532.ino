...
//------------------------------------------- MPR121 code
// Libraries for Capacitive Sensor MPR121
#include "mpr121.h"
#include <Wire.h>
...
{
//-------------------------------MPR121
//    Serial.println("\nReading selectors (MPR121)\n");
//    readTouchInputs();
//------------------------------PN532
//Serial.println("\nScan a NFC tag (PN532)\n");

    String payloadStr = "logof";
    if (nfc.tagPresent())
    {
        NfcTag tag = nfc.read();
